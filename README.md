# 🖥️ OS Administration – ASIR Module
...
Bash scripts focused on loops, conditionals, file management, and simple automation tasks. It also contains more interesting exercises such as a memory‑monitoring script that alerts when usage exceeds 75%, and a network‑scanning script that detects active devices on the local network. There are too many of them.
